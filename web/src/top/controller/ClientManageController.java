...
//			client = new Client("192.168.43.2", 8888); 
			String serverIp = "15.164.97.232"; // AWS hyunsu
			client = new Client(serverIp, 8888); // AWS hyunsu
...
//	             String ServerIp="70.12.224.85";
	...
	public void sendNotiFromIoTClient(HttpServletRequest req, HttpServletResponse res) {
		...
		conn.setRequestProperty("Authorization", "key="
				+ "AAAAFk5kK0o:APA91bF6QwT4M9o2UYk_kCjwaJYeY8YYwAx2gbrmT8W-2Hs3ZvfldPaUQ8Q1R60K2ZvO9_K8vqupbUE3i5n-ngFjb_TdlsjeCXRrm3r89Ds-r9ZzRIaM_7Tcd_Mww7o8NAKjh21m-bSA");
//		conn.setRequestProperty("Authorization", "key="
